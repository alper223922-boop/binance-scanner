...
TELEGRAM_TOKEN   = os.getenv("TELEGRAM_TOKEN", "AAHbmCBU2JJS0fsKZyH6xY0SERzkWG-wqWM")
TELEGRAM_CHAT_ID = os.getenv("TELEGRAM_CHAT_ID", "AAHbmCBU2JJS0fsKZyH6xY0SERzkWG-wqWM")
